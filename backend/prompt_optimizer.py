...
def truncate_with_sentence_boundary(
    text: str, max_chars: int, preserve_end: bool = False
) -> str:
    """
...
def compress_text(
    text: str, max_chars: Optional[int] = None, deduplicate: bool = True
) -> str:
    """
...
def optimize_conversation_history(
    ...
    for i, msg in enumerate(history):
        ...
        optimized.append({"role": msg.get("role", "user"), "content": content})
...
def get_optimization_stats(original: str, optimized: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "reduction_percent": round((1 - optimized_chars / original_chars) * 100, 1)
        if original_chars > 0
        else 0,
